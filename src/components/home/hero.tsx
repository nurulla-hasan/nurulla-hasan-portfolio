  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-background pt-10 text-foreground">
      ...
      <div className="relative z-10 mx-auto grid min-h-screen max-w-7xl items-center gap-16 px-6 py-20 md:gap-24 lg:grid-cols-[1.05fr_0.95fr] lg:px-10 lg:py-0">
        ...
        {/* Right */}
        <div className="relative flex h-87.5 items-end justify-center sm:h-112.5 lg:h-180 lg:justify-end -mt-5 lg:-mt-20">
          {/* Big faded circle */}
          <div className="absolute right-[6%] top-[13%] h-135 w-135 rounded-full border" />

          <div className="relative z-10 flex h-full w-full items-end justify-center lg:justify-end">
            <div className="relative h-full w-full max-w-155 mb-10 lg:mb-24 mask-[linear-gradient(to_bottom,black_80%,transparent_100%)]">
              <Image
                src="/without-bg.png"
                alt="Nurulla Hasan"
                fill
